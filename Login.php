        ...
        <section class="min-h-screen flex items-center flex-col justify-center">
            <div class="bg-white mx-auto max-w-500 py-10 px-40 shadow rounded-lg border border-amber-900 border-4">
                ...
                <form action="">
                    ...
                    <div class="mb-4">
                        <button class="inline-block w-full px-8 py-3 leading-none text-white bg-amber-800 rounded hover:bg-amber-900 font-semibold shadow">Iniciar Sesión</button>
                    </div>
                    <div>
                        <h4 class="mb-2 text text-xs">Al continuar, aceptas las Condiciones de uso y el Aviso de privacidad de Huelic.</h4>
                    </div>
                    <div>
                        <h3 class="mb-2 text text-center"> ---------- Eres Nuevo en Huelic ----------</h3>
                    </div>
                    <div class="mb-8">
                        <button class="inline-block w-full px-8 py-3 leading-none text-white bg-slate-400 rounded hover:bg-slate-500 font-semibold shadow border border-amber-900 border-2">Crear tu cuenta Huelic</button>
                    </div>
                </form>
            </div>
